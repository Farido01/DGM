...
const dotsLeft: AnimatedDot[] = [
  ...
  // 3. Bottom 20 dots from Line 1 (Last 10 dots transition over top hook down col 10.5, row 7..2)
  ...
  // 5. Bottom 20 black dots from Line 2 (Last 10 dots transition over top hook down col 11.0, row 7..2)
